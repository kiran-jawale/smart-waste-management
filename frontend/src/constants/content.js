...
export const content = {
  ...
  home: {
    ...
    howToUse: {
      ...
      steps: [
        {
          name: "1. Register",
          desc: "Create an account as a Citizen or Organisation to get started.",
        },
        {
          name: "2. Report or Request",
          desc: "File a complaint for an overflowing bin or request a special pickup for e-waste.",
        },
        {
          name: "3. We Assign",
          desc: "Our system instantly routes your request to the nearest available Collector.",
        },
        {
          name: "4. Track & Resolve",
          desc: "Track the status of your report in real-time from your personal dashboard.",
        },
      ],
    },
   wasteTypes: {
  ...
  contact: {
    ...
    details: [
      ...
      {
        name: "Address",
        value: "Municipal Corporation, Chhatrapati Sambhajinagar",
      },
    ],
  },
};
